...
class TestAgentProtocol:
    ...
    def test_agent_protocol_exists(self):
        ...
        from ralph_loop.agents import Agent
...
class TestAgentResult:
    ...
    def test_agent_result_exists(self):
        ...
        from ralph_loop.agents import AgentResult
...
class TestAgentConfig:
    ...
    def test_agent_config_exists(self):
        ...
        from ralph_loop.agents import AgentConfig
...
class TestAgentRegistry:
    ...
    def test_get_agent_function_exists(self):
        ...
        from ralph_loop.agents import get_agent
