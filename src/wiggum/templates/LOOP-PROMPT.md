...
3. **If task references a spec file** (e.g., `see specs/feature.md`), read it first
4. **Decide if this task needs tests**:
...
5. Implement the task (test-first if tests are needed)
6. Run tests to verify nothing broke
7. **Simplify**: Review the code you touched and ask:
...
8. **Update docs**: Ensure documentation ({{doc_files}}) matches the implementation
9. Update TASKS.md: mark task as `[x]` and move it to the `## Done` section
